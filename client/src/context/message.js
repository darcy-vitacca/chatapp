...
const messageReducer = (state, action) => {
  ...
  switch (action.type) {
    ...
    case "SET_USER_MESSAGES":
      //this sets in the provider a selected true or false value so this goes through each user and sets if username = action payload the value of selected to true or false. This little sections copies the current users from state then once a username is recieived from state we create a copy find the index of the username then spread that user in the new users and add the messages object to it.
